...
function WorkspaceHeader({ onSave }: any) {
    return (
        <div className="h-[64px] p-3 border-b flex justify-between items-center bg-enm-bg-side-nav">
            ...
            <div className="flex items-center gap-4">
                <Link href="/meeting/home">
                    ...
                    <div className="h-8 flex items-center h-full w-full border-2 border-pink-300 px-3 rounded-md">
                        ...
                        <h1 className="text-[16px] font-bold py-1 pl-4 bg-gradient-to-r from-pink-400 via-pink-300 to-sky-400 inline-block text-transparent bg-clip-text">
                            Meeting
                        </h1>
                    </div>
                </Link>
            ...
            <div className="flex items-center gap-4">
                <Button
                    className="h-8 text-[12px] gap-2 bg-gradient-to-r from-pink-500 to-enm-primary hover:from-pink-600 hover:to-sky-600"
                    onClick={() => onSave()}
                >
