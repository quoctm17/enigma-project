...
function CreateTeam() {
    ...
    const createNewTeam = async () => {
        ...
        try {
            console.log('Creating team with:', { teamName, createBy: user.email, image: user.picture });
    ...
    return (
        <div className='px-6 md:px-16 py-16 min-h-screen bg-enm-bg'>
            ...
            <div className='flex flex-col items-center mt-8'>
                ...
                <Button
                    className='text-[18px] bg-gradient-to-r from-pink-500 to-enm-primary hover:from-pink-600 hover:to-sky-600 mt-10 w-[30%]'
