  ...
  return (
    <section className="bg-black">
      ...
      justify-center pt-20'>
        ...
        text-center border-white'>See Somethings News | <span className='text-sky-400'>AI Diagram</span> </h2>
      </div>
      <div className="mx-auto h-screen max-w-screen-xl px-4 py-12 lg:flex">
        <div className="mx-auto max-w-xl text-center">
          ...
          <p className="mt-4 sm:text-xl/relaxed text-slate-200">
            All-in-one markdown editoer, collaborative canvas, and diagram-as-code builder
          </p>
